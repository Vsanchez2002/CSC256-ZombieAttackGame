...
; %bb.0:
	...
	str	w0, [sp, #56]
	str	x1, [sp, #48]
	adrp	x8, l___const.main.zombie@PAGE
	add	x8, x8, l___const.main.zombie@PAGEOFF
	ldr	q0, [x8]
	stur	q0, [x29, #-48]
	ldr	q0, [x8, #16]
	stur	q0, [x29, #-32]
...
; %bb.0:
	...
	.p2align	2                               ; @__const.main.zombie
l___const.main.zombie:
	.long	0                               ; 0x0
	.long	25                              ; 0x19
	.long	10                              ; 0xa
	.long	15                              ; 0xf
...
l_.str:                                 ; @.str
	.asciz	"Must specify the Human X and Y coordinates:  ./ZombieAttack 42 24\n"

l_.str.1:                               ; @.str.1
	.asciz	"The Human's coordinates are: ("
...
l_.str.5:                               ; @.str.5
	.asciz	" - the zombies are closing in"
